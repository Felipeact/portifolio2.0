...
export default function ListItem({ movie } : ListItemProps ) {
  return (
    <div className="flex flex-col lg:flex-row items-start space-x-6 p-6">
        <ReactPlayer url={movie.image} 
      ...
      <div className="min-w-0 relative flex-auto mt-8">
        <h2 className="font-semibold text-purple-500 truncate pr-20">{movie.title}</h2>
        <dl className="mt-2 flex flex-wrap text-sm leading-6 font-medium">
          ...
          <div className="flex-none w-full mt-2 font-normal">
            ...
            <dd className="text-green-400">{movie.cast}</dd>
          </div>
        </dl>
      </div>
    </div>
