    ...
    return (
        ...
        <Link href={`/blog/${projectId}`}>
            <div className="flex items-center space-x-2 mt-8">
                <button className="relative flex  items-center border-2 border-solid border-black p-2 rounded-full hover:bg-[url(../../public/matrix-animation.gif)] hover:text-white hover:font-bold transition delay-150 duration-300 ease-in-out">
